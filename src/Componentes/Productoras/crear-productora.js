...
const CrearProductora = () => {
    ...
    return (
        <div className="container">
            <h1 className="text-center mt-5 text-white fw-bold">Crear Productoras</h1>
                ...
                <div className="mb-4 mt-4 row">
                    ...
                    <div className="col-md-4">
                        <div className="form-outline">
                            ...
                            <input id="slogan" value={slogan} onChange={(e) => setSlogan(e.target.value)} type="text" className="form-control" />
                        </div>
                    </div>
                </div>
