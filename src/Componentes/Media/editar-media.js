    ...
    useEffect(() => {
        const getMediaById = async () => {
            try {
                ...
                setProductora(res.data.productora);
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-outline">
                    ...
                    <select id="genero" name="genero" value={genero} onChange={(e) => setGenero(e.target.value)} className="form-select">
                      {generos.map((gen) => (
                ...
                <div className="col-md-6">
                  <div className="form-outline">
                    ...
                    <select id="tipo" name="tipo" value={tipo} onChange={(e) => setTipo(e.target.value)} className="form-select">
                      {tipos.map((tip) => (
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-outline">
                    ...
                    <select id="director" name="director" value={director} onChange={(e) => setDirector(e.target.value)} className="form-select">
                ...
                <div className="col-md-6">
                  <div className="form-outline">
                    ...
                    <select id="productora" name="productora" value={productora} onChange={(e) => setProductora(e.target.value)} className="form-select">
